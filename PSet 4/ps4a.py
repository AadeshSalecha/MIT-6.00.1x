...
WORDLIST_FILENAME = "C:\Users\Aadesh\Desktop\ProblemSet4\words.txt"
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while (calculateHandlen(hand_cpy) > 0):
        # Display the hand
        a = ''
        for i in hand_cpy.keys():
            a = a + ' ' + i
        ...
        # Otherwise (the input is not a single period):
            ...
            if not isValidWord(word,hand_cpy,wordList):
            ...
            # Otherwise (the word is valid):
                ...
                print
                # Update the hand 
                hand_cpy= updateHand(hand_cpy, word)
...
def playGame(wordList):
    ...
    while(True):
        ...
        inpu = str(raw_input())
        # hand =  dealHand(random.choice(range(1,11)))
        if (inpu == 'e'):
            break
        elif (inpu == 'r'):
            if (prev_hand == 0):
